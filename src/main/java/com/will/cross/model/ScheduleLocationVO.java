...
public class ScheduleLocationVO {
    ...
    public List<AreaVO> getAreaName() {
        return areaName;
    }

    public void setAreaName(List<AreaVO> areaName) {
        this.areaName = areaName;
    }

    public List<PersonVO> getPersonName() {
        return personName;
    }

    public void setPersonName(List<PersonVO> personName) {
        this.personName = personName;
    }

    private String locaName;

    private List<AreaVO> areaName;

    private List<PersonVO> personName;
